...
1. **Power Distribution Board (PDB)** — takes 4S LiPo battery input and generates regulated 5V and 3.3V rails while distributing raw battery power to the ESC.
2. **Flight Controller (FC)** — an STM32F405-based, Betaflight-compatible flight controller with a full peripheral set.
